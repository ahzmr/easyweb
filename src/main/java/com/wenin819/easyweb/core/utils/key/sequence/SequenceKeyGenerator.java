...
public class SequenceKeyGenerator implements KeyGenerator {
     ...
     * 主键表名
     */
    protected static final String KEY_SEQUENCE_TABLENAME = Configs.schameConfigplat() + ".SYS_KEY_SEQUENCE";
    /**
     * 查询Sql
     */
